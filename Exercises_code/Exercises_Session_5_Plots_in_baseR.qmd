...
### Solution Exercise 1 {#sec-solution-exercise-3 style="background-color: #e7fccc"}
...
Petal.Length) will make a boxplot.
...
```{r}
barplot(mean_measurements_pers_pp$Petal.Length~mean_measurements_pers_pp$Group.1, ylab="Mean Petal Length", xlab="Species of Iris")
```
