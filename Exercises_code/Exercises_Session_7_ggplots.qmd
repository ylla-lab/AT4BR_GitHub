...
-   Make a boxplot layer colored by condition and treatment (you can use
    function `intersection()` when filling or coloring ).
...
\>800 TPMs within all controls or within all treated samples (tip: sum
in each group).
